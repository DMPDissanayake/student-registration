...
class AppDimensions {
  ...
  // Font size 36
  static double get kFontSize36 => 36.sp;
  static double kLineHeight36(double lineHeight) => lineHeight / 36;
  static double kLetterSpacing36(double percentage) =>
      (percentage / 100) * 36.sp;

  // Font size 38
  static double get kFontSize38 => 38.sp;
  static double kLineHeight38(double lineHeight) => lineHeight / 38;
  static double kLetterSpacing38(double percentage) =>
      (percentage / 100) * 38.sp;
